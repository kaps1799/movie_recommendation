...
<div class="container">
    ...
    <div style="text-align:center", class="jumbotron">
        <h2>Respected Teachers<h2>
        <!-- <?php echo $userRow['username']; ?>  -->
        <h1>Welcome to Movie Recommendation System!</h1>
        <h2><strong>Made by:</strong></h2>
        <h3>Kapil Parsodkar <em>(17070123073)</em></h3>
        <h3>Abhishek Malwe <em>(17070123006)</em></h3>
        <h3>Nikhil Raj <em>(17070123067)</em></h3>
        <h3>Hemanth Polishetty <em>(17070123074)</em></h3>
        <br>
        <h2><strong>Under the guidance of</strong></h2>
        <h2>Dr. Harikrishnan R.</h2>
        <br>
